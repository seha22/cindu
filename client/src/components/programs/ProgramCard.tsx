...
export default function ProgramCard({ program, onDonate }: ProgramCardProps) {
  ...
  return (
    <div className="group bg-card rounded-3xl overflow-hidden border border-border/50 shadow-lg shadow-black/5 hover:shadow-2xl hover:shadow-primary/10 transition-all duration-300 flex flex-col">
      ...
      <div className="p-6 flex flex-col flex-1">
        <h3 className="font-display font-bold text-xl text-foreground mb-2 line-clamp-2 leading-tight">
          {program.title}
        </h3>
        ...
        <Button 
          ...
          className="w-full py-6 rounded-xl font-bold bg-primary hover:bg-primary/90 text-white shadow-md shadow-primary/20 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200"
        >
